...
function recursive_comment($comment,$parent=false){
	...
	$out.='<div class="middle-area"> <a class="name"><b>'.$comment->comment_author.'</b></a> <h6 class="date">on Sep 29, 2017 at </div>';
	$out.='<div class="right-area"> <h5 class="reply-btn"><a href="#reply"><b>REPLY</b></a></h5> </div></div><!-- post-info -->';
